...
SizeClass classifyByName(const QString &stem) {
  const QString lower = stem.toLower();
  struct Hint { const char *kw; SizeClass cls; };
  static const Hint hints[] = {
    {"fr-max",   SizeClass::Compact},   {"frmax",    SizeClass::Compact},
    {"fr_max",   SizeClass::Compact},   {"fanuc",    SizeClass::TinyRobot},
    {"kuka",     SizeClass::TinyRobot}, {"abb",      SizeClass::TinyRobot},
    {"agv",      SizeClass::TinyRobot}, {"cobot",    SizeClass::TinyRobot},
    {"robot",    SizeClass::TinyRobot},
    {"sprinter", SizeClass::Truck},     {"f-150",    SizeClass::Truck},
    {"f150",     SizeClass::Truck},     {"f-450",    SizeClass::Truck},
    {"silverado",SizeClass::Truck},     {"transit",  SizeClass::Truck},
    {"truck",    SizeClass::Truck},     {"lorry",    SizeClass::Truck},
    {"bus",      SizeClass::Bus},       {"coach",    SizeClass::Bus},
    {"gls",      SizeClass::Suv},       {"q7",       SizeClass::Suv},
    {"x5",       SizeClass::Suv},       {"jeep",     SizeClass::Suv},
    {"tahoe",    SizeClass::Suv},       {"escalade", SizeClass::Suv},
    {"defender", SizeClass::Suv},       {"range-rover", SizeClass::Suv},
    {"range_rover", SizeClass::Suv},    {"suv",      SizeClass::Suv},
    {"mkz",      SizeClass::Sedan},     {"mustang",  SizeClass::Sedan},
    {"camry",    SizeClass::Sedan},     {"accord",   SizeClass::Sedan},
    {"sedan",    SizeClass::Sedan},     {"impala",   SizeClass::Sedan},
    {"audi-tt",  SizeClass::Compact},   {"miata",    SizeClass::Compact},
    {"cooper",   SizeClass::Compact},   {"polo",     SizeClass::Compact},
    {"golf",     SizeClass::Compact},
  };
...
MeshAnalysisResult analyzeMesh(const MeshGeometry &g, float scaleToCm) {
  ...
  for (int i = 0; i < numClusters; ++i) {
    ...
    if (b.zMin > zFloor + approxRadius * 0.5f) continue;
    ...
    const float floorBias   = 1.0f - (b.zMin - zFloor) / std::max(approxRadius, 1.0f);
